 ...
 * para apresentação de grafos no Web browser utilizando as classes do pacote awt.
 *
...
public class AreaApplet extends Panel implements MouseMotionListener, MouseListener, KeyListener
{
	...
	/**
	 * Cria uma nova área de apresentação do grafo ou diagrama utilizada pela
	 * <B>Applet</B> instânciada. Para criar está nova área, deve-se passar 
	 * uma applet de edição do pacote GEDE.
	 *
	 * @param editorGrafo a applet que conterá a área de apresentação
	 ...
	 * 
	 * @param desenhar o contexto gráfico que desenhará o grafo na área da applet
	...
	/**
	 * Retorna o editor de applet atual da área de desenho do grafo.
	 *
	...
	/**
	 * Retorna o grafo atual desenhado na área do editor applet.
	 * 
	...
	//Métodos do MouseMotionListener
	 ...
	 * os métodos de arraste das classes MenuMouseArea, MenuMouseAresta, 
	 * MenuMouseRotulo e MenuMouseVertice sempre serão invocados antes de executar
	 ...
	 *
	 * Um observação importante dentro do contexto do editor de diagramas é que 
	 * os métodos de movimentação das classes MenuMouseArea, MenuMouseAresta,
	 * MenuMouseRotulo e MenuMouseVertice sempre serão invocados antes de 
	 ...
	 *
	 * Um observação importante dentro do contexto do editor de diagramas é que 
	 * os métodos de clique com o botão direito do mouse das classes MenuMouseAresta,
	 * MenuMouseArea, MenuMouseRotulo e MenuMouseVertice sempre serão 
	 ...
	 *
	 * Um observação importante dentro do contexto do editor de diagramas é que 
	 * os métodos de entrada do mouse das classes MenuMouseArea, MenuMouseAresta,
	 * MenuMouseRotulo eJMenuMouseVertice sempre serão invocados antes de 
	 * executar suas operações implementadas.
	 *
	 * @param e o evento do mouse
	 ...
	 *
	 * Um observação importante dentro do contexto do editor de diagramas é que 
	 * os métodos de saída do mouse das classes MenuMouseArea, MenuMouseAresta,
	 * MenuMouseRotulo e MenuMouseVertice sempre serão invocados antes de 
	 * executar suas operações implementadas.
	 *
	 * @param e o evento do mouse
	 ...
	 *
	 * Um observação importante dentro do contexto do editor de diagramas é que 
	 * os métodos de botão do mouse pressionado das classes MenuMouseArea, 
	 * MenuMouseAresta, MenuMouseRotulo e MenuMouseVertice sempre serão 
	 * invocados antes de executar suas operações implementadas.
	 *
	 * @param e o evento do mouse
	 ...
	 *
	 * Um observação importante dentro do contexto do editor de diagramas é que 
	 * os métodos de botão do mouse liberado das classes MenuMouseArea, 
	 * MenuMouseAresta, MenuMouseRotulo e MenuMouseVertice sempre serão 
	 * invocados antes de executar suas operações implementadas.
	 *
	 * @param e o evento do mouse
